#!/usr/bin/env python3
"""
codex-blog brand-kit generator.

Same brand system as claude-ads + codex-seo v2.x: OS-window-framed dark CRT
...
# ============================================================================
# BRAND-ORANGE PALETTE — unified across claude-ads + codex-seo + codex-blog
# ============================================================================
ACCENT          = "#D97757"
...
def svg(viewbox_w, viewbox_h, body, corner="codex-blog · v1.9.0", win_title=None):
    if win_title is None:
        win_title = f"codex-blog.app — {corner}"
