...
Consumes a JSON file of pre-gathered SERP / web search results and produces:
...
search to have been performed upstream (by Claude via web search, or by another
...
script uses pre-gathered web search results.
