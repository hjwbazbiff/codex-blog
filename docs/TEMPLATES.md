...
Reference guide for the 12 content type templates included with `codex-blog`.
...
1. Navigate to `${CODEX_HOME:-$HOME/.codex}/skills/blog/templates/`
...
1. Copy an existing template as a starting point:
   ```bash
   cp ${CODEX_HOME:-$HOME/.codex}/skills/blog/templates/how-to.md \
      ${CODEX_HOME:-$HOME/.codex}/skills/blog/templates/my-custom-type.md
   ```
