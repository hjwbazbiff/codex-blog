...
|---|---|---|---|
| `AI-Marketing-Hub/codex-blog` (origin) | Working repo. All in-development changes land here first. | Private | AI Marketing Hub Pro community + maintainers |
| `AgriciDaniel/codex-blog` (public-mirror) | Release mirror. Receives reviewed, approved versions of work. | Public | Open-source community, no membership required |
...
1. **Work in `origin`** (the private repo, `AI-Marketing-Hub/codex-blog`).
...
3. **Pre-release sanity check** (run locally before pushing to public):
   ...
   python -m pytest tests/ .                        # marketplace manifest valid
   ```
...
git remote -v
# origin    https://github.com/AI-Marketing-Hub/codex-blog.git (fetch)
# origin    https://github.com/AI-Marketing-Hub/codex-blog.git (push)

# Add the public mirror as a second remote:
git remote add public-mirror https://github.com/AgriciDaniel/codex-blog.git
git remote -v
# origin          https://github.com/AI-Marketing-Hub/codex-blog.git (fetch)
# origin          https://github.com/AI-Marketing-Hub/codex-blog.git (push)
# public-mirror   https://github.com/AgriciDaniel/codex-blog.git (fetch)
# public-mirror   https://github.com/AgriciDaniel/codex-blog.git (push)
```
...
- `~/Desktop/codex-blog-audit-YYYY-MM-DD/` proof folders (live outside the repo)
...
```
origin            -> AI-Marketing-Hub/codex-blog (private, working repo)
public-mirror     -> AgriciDaniel/codex-blog     (public, release mirror)
