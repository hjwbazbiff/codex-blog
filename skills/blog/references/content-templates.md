...
Templates are editable markdown files in `${CODEX_HOME:-$HOME/.codex}/skills/templates/`.
...
1. Copy an existing template as a starting point:
   ```bash
   cp ${CODEX_HOME:-$HOME/.codex}/skills/templates/how-to-guide.md \
      ${CODEX_HOME:-$HOME/.codex}/skills/templates/my-custom-type.md
   ```
