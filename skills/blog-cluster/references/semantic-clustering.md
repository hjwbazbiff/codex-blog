...
Use web search to expand the seed keyword into 30 to 50 candidate phrases:
...
1. web search keyword A. Note the top 10 organic result URLs (domain plus path).
2. web search keyword B. Note the top 10 organic result URLs.
...
Use web search to identify the key entities Google associates with the topic:
