...
description: >
  ...
  Codex acts as Creative Director - interpreting intent, selecting domain expertise,
...
When invoked as a Codex subagent from blog-write or blog-rewrite:
...
1. Run `python3 scripts/setup_image_mcp.py` (interactive)
   ...
   - Default writes to `${CODEX_HOME:-$HOME/.codex}/settings.json` (user-private, mode 0600)
