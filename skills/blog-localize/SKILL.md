...
license: MIT
compatibility: Standalone within codex-blog. Invoked by blog-multilingual.
metadata:
  author: AgriciDaniel
...
> Adapted from `codex-blog-multilingual` by Chris Mueller (Pro Hub Challenge,
...
- Use web search to find local case studies, brands, or scenarios.
