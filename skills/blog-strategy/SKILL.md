...
Strategy planning should consider the FLOW 5-surface model (owned site, SERP plus AI Overviews, AI assistant citations, local pack, communities and video). Local-pack work is delegated to `codex-seo`; everything else lives inside codex-blog. Full mapping in `skills/blog/references/flow-alignment.md`.
...
1. web search for competitor blog URLs
...
Map competitor visibility across AI platforms. Use web search to find how
