...
5. Download and store securely (e.g., `~/.config/codex-seo/service_account.json`)
...
4. Store at `~/.config/codex-seo/oauth_client.json`
...
Config is shared with codex-seo at `~/.config/codex-seo/google-api.json`:
