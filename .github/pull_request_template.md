...
- [ ] No version-count drift (sub-skills count consistent across README, plugin.json, AGENTS.md, docs/COMMANDS.md, blog/SKILL.md)

## Security checklist (if applicable)
- [ ] No new hardcoded secrets, API keys, or credentials
- [ ] No new `shell` tool grants in agent frontmatter (`tests/test_security_guardrails.py` enforces)
- [ ] No new `tool permissions` field (invalid in SKILL.md frontmatter)
